...
============小火箭=========
京喜牧场 = type=cron,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd/jxmc.js, cronexpr="20 0-23/2 * * *", timeout=3600, enable=true
 */
...
!(async () => {
  ...
  $.res = await getAuthorShareCode('https://raw.githubusercontent.com/atyvcn/updateTeam/master/shareCodes/jd/jxmc.json')
