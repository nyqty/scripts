...
function getCk(){
	return new Promise(_0x19a6ea=>{
		let _0x16e7b0={'url':'https://lzdz1-isv.isvjd.comgzhi/joinCommon/activity/activity?activityId='+$.activityId+'&shareUuid='+$.shareUuid,'followRedirect':false,'headers':{'User-Agent':$.UA},'timeout':30000};
