...
!(async () => {
  console.log(`\n【抢京豆脚本】优先账号内部互相助力，有剩余次数再助力【atyvcn】\n`)
  ...
  if (cookiesArr.length > 2) {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
      ...
      console.log(`${$.UserName}账号内部互助已完成，尝试帮【atyvcn】助力`)
...
function getAuthorShareCode() {
  return new Promise(resolve => {
    $.get({
      url: "https://raw.fastgit.org/atyvcn/updateTeam/master/shareCodes/jd/updateBeanHome.json",
      headers: {
