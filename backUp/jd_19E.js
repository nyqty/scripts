    ...
    return new Promise((resolve) => {
        $.get({
            ...
            headers: {
                ...
                'Referer': `https://shopmember.m.jd.com/shopcard/?venderId=${venderId}&shopId=${venderId}&venderType=5&channel=401&returnUrl=https://lzdz1-isv.isvjd.comgzhi/personal/care/activity/4540555?activityId=dz210768869313`,
