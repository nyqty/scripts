...
let inviteCodes = [ ['xDZ0HmcBlJQUMs_WF5h_mmvv-Ep-xFCOB0aPa1RY','RtGKopnzA3HfI9jbYaF1msS66HLnJFw6y6kB3Pwlqq4woTB-','RtGKirrwF1nmJvjLcJNiml9RYFvusBk61XyCgVF23KihTV48'].sort(() => 0.5 - Math.random()).join('@')]
!(async () => {
  if (!cookiesArr[0]) {
