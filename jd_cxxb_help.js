/*
cron "10 20 * * *" ty_jd_cxxb_help.js, tag:TY自己写的获取指定用户膨胀码助力

QQ1659670408
*/
const $ = new Env('穿行寻宝-膨胀助力');
...
!(async() => {
    ...
    let code,inviteCode,ok_UserNames;
                           ...
                           /*
{
  ...
  "data": {
    ...
    "bizMsg": "success",
    "result": {
      "ext": "2022.10.20-2022.10.23",
      "pin": "jd***a",
      "securityCode": "1v9XMRWXV8KqF9GtbuIBn0PLTdWW",
      "status": 1,
      "value": "5.65"
    },
    "success": true
...
领取:-5您没有可领取的红包哦~
                           */
                            switch(data['data']['bizCode']){
                                case 0:
                                    console.log(`领取成功:${data['data']['bizMsg']}`);
                                    resolve(1)
                                    break;
                                default:
