...
* > 【青龙】拉取仓库命令：`ql repo https://github.com/atyvcn/jd_scripts.git "jd_|jx_|getJDCookie"  "backUp|icon" "^jd[^_]|USER|sendNotify|sign_graphics_validate|JDJR|JDSign" "main"`
  * > 上面命令拉取错误的使用这个：`ql repo https://ghproxy.com/https://github.com/atyvcn/jd_scripts.git "jd_|jx_|getJDCookie"  "backUp|icon" "^jd[^_]|USER|sendNotify|sign_graphics_validate|JDJR|JDSign" "main"`
