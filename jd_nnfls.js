...
!(async () => {
    ...
    await getShareCode('nnfls.json', "atyvcn", 3, true)
...
function getShareCode(name, author = 'atyvcn', num = -1, shuffle = false) {
    return new Promise(resolve => {
        $.get({
            url: `https://raw.fastgit.org/${author}/updateTeam/master/shareCodes/jd/${name}`,
            headers: {
