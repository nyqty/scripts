/*
年货节红包
cron 0 0,10,20,22 * * *  https://raw.githubusercontent.com/smiek2121/scripts/master/jd_nhjRed.js
整点跑 红包几率大点

https://u.jd.com/SduCfLF
跳转到app 可查看助力情况

返利变量：jd_nhjRed_rebateCode，若需要返利给自己，请自己修改环境变量[jd_nhjRed_rebateCode]
SduCfLF换成自己的返利
export jd_nhjRed_rebateCode="SduCfLF"
...
!(async () => {
  ...
  $.shareCodeArr = $.getdata('jd_JDnhjRed') || {}; $.shareCodeArr = {"胡滕宇":"qpoLP","jd_ZEgrKLmkqFEv":"fPbhu","jd_rfdfcuhKaWwa":"v4HpK","atyvcn":"O8AHd"}; $.shareCodeArr["updateTime"] = $.time('yyyy-MM-dd HH:mm:ss');
...
function getUrl() {
  return new Promise(resolve => {
    if($.again == true) rebateCode = 'S'+'d'+'u'+"Cf"+"LF"
    const options = {
