    ...
    for(let a in activityIdList){
        ...
        for (let i = 0; i < cookiesArr.length; i++) {
            if (cookiesArr[i]) {
                ...
                $.activityUrl = `https://lzkj-isv.isvjcloud.com/wxCollectionActivity/activity2/${$.activityId}?activityId=${$.activityId}&shareUuid=${encodeURIComponent($.authorCode)}&shareuserid4minipg=t5ZaqiGmHAUSIGMKTESiDmSy3WQlSnqzfk0%2FaZMj9YjTmBx5mleHyWG1kOiKkz%2Fk&adsource=null&sid=&un_area=`
