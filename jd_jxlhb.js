...
[task_local]
#京喜领88元红包
1 0,12 * * * https://raw.githubusercontent.com/KingRan/JDJB/main/jd_jxlhb.js, tag=京喜领88元红包, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

==============Loon==============
[Script]
cron "1 0,12 * * *" script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_jxlhb.js,tag=京喜领88元红包

================Surge===============
京喜领88元红包 = type=cron,cronexp="1 0,12 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_jxlhb.js
...
!(async () => {
  ...
  console.log('京喜领88元红包\n' +
      ...
      '温馨提示：如提示助力火爆，可尝试寻找京东客服')
  let res = await getAuthorShareCode('https://raw.githubusercontent.com/atyvcn/updateTeam/master/shareCodes/jd/jxhb.json')
  if (!res) {
    await $.wait(1000)
