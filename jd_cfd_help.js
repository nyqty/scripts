...
!(async () => {
  ...
  if (HelpAuthorFlag) {
    ...
    $.innerInviteList = [...(res && res || [])]
    getShareNums = $.innerInviteList.length >= getShareNum ? getShareNum : $.innerInviteList.length
    $.innerInviteLists = getRandomArrayElements($.innerInviteList, $.innerInviteList.length >= getShareNum ? getShareNum :$.innerInviteList.length );
