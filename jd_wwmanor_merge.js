...
function _0x1208e7() {
  return new Promise(async _0x462a7d => {
    ...
    $.post(_0x531059, async (_0x4ff26f, _0x33dfd5, _0x6b4ea1) => {
      try {
        _0x4ff26f ? (console.log("" + JSON.stringify(_0x4ff26f)), console.log("getGameShopList API请求失败，请检查网路重试")) : _0x6b4ea1 = JSON.parse(_0x6b4ea1).data.filter(_0x44c1c6 => _0x44c1c6.shopStatus === 1);
      } catch (_0x5a7a58) {
...
function _0xf9c731() {
  return new Promise(async _0x26a535 => {
    ...
    $.post(_0x3077e6, async (_0x2fc1a8, _0x1cfb8f, _0x40ff4d) => {
      try {
        if (_0x2fc1a8) {
          console.log("" + JSON.stringify(_0x2fc1a8));
          console.log("newStartReward API请求失败，请检查网路重试");
        } else {
...
function _0x4595a4(_0x58e986, _0x466983, _0x2c96f9, _0x50ee9d) {
  return new Promise(async _0xff3d96 => {
    ...
    $.post(_0x34b638, async (_0xf6f7e, _0x932d42, _0xde44f8) => {
      try {
        _0xf6f7e ? (console.log("" + JSON.stringify(_0xf6f7e)), console.log("apCashWithDraw API请求失败，请检查网路重试")) : (_0xde44f8 = JSON.parse(_0xde44f8), _0xde44f8.success && _0xde44f8.data && console.log("提现结果：" + JSON.stringify(_0xde44f8)));
      } catch (_0x414c29) {
